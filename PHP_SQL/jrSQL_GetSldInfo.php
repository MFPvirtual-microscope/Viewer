...
//	jrSQL_GetSlideInfo.php is part of the "Multifocal-plane Virtual Microscope", which is an internet 
...
//		This *.php file (jrSQL_GetSlideInfo.php) is part of the Viewer.  Currently, the Viewer consists
