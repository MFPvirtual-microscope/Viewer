...
//	jrSQL_GetZYX.php is part of the "Multifocal-plane Virtual Microscope", which is an internet 
...
//		This *.php file (jrSQL_GetZYX.php) is part of the Viewer.  Currently, the Viewer consists
//		of 18 principal files and other supplementary files:
//		- one HTML file.
//		- two cascading style sheets.
//		- 12 javascript files.
//		- three PHP files (including jrSQL_GetZYX.php).
...
function jrSQLQuery($sldNum) {
	...
	$dbname = "slideData";   // NOTE: 5/03/22 - Need to change SQL database to match change in dbname.
			// Create connection
