...
//	jrSQL_GetSlideBasic.php is part of the "Multifocal-plane Virtual Microscope", which is an internet 
//		web-based program that displays digitally-scanned microscopic specimens.
...
//		This *.php file (jrSQL_GetSldBasic.php) is part of the Viewer.  Currently, the Viewer consists
//		of 18 principal files and other supplementary files:
//		- one HTML file.
//		- two cascading style sheets.
//		- 12 javascript files.
//		- three PHP files (including jrSQL_GetSlideBasic.php).
...
// Note: to be compatible with javascript's alert() function, the error statements use
...
function jrSQLQuery($sldNum) {
	...
	$dbname = "slideData";   // NOTE:  5/03/22 - need to fix the SQL database for this change
			// Create connection
