...
//	jrscpTouchMain.js is part of the "Multifocal-plane Virtual Microscope", which is an internet web-based program that
...
//		(jrscpTouchMain.js) is part of the Viewer.  Currently, the Viewer consists 
//		of 18 principal files and other supplementary files:
//		- one HTML file.
//		- two cascading style sheets
//		- 12 javascript files (including jrscpTouchMain.js)
//		- three PHP files
