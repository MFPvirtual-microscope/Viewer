...
//	jrscpMove.js is part of the "Multifocal-plane Virtual Microscope", which is an internet web-based program that
...
//		(jrscpMove.js) is part of the Viewer.  Currently, the Viewer consists 
//		of 18 principal files and other supplementary files:
//		- one HTML file.
//		- two cascading style sheets
//		- 12 javascript files (including jrscpMove.js)
//		- three PHP files
//	jrscpMove.js contains javascript functions that are involved in moving the specimen within the Viewer's main window.
...
function sldMvBtnOut(btnNum,btnNode) {
	...
	//		1/29/20:  multiplied mvStpSz by glbMvBtnDir
...
function sldMvBtnDown(mvBtnNum,mvBtnShftKey,btnNode) {
	...
	var stpSzBig = sldMvStepSz * sldMvStepMult;  //stpSzBig is the large step-size; can be adjusted by stpSzMax
	...
	if ((btnDig2 == 1) || (btnDig2 == 3)) { mvStepSz *= -1 * glbMvBtnDir; }  // button is Up or Left, mvStepSz is negative
	else { mvStepSz *= glbMvBtnDir; }
